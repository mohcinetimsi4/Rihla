...
const Profile = () => {
    ...
    <Link 
        to="/diary" 
        className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-5 py-2.5 rounded-full transition-colors text-sm shadow-md"
    >
        <span>📖</span> Mon Journal
    </Link>
