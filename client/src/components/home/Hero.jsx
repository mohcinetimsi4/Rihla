    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center px-6 pt-24 pb-20">
                ...
                {/* Search Bar */}
                <div className="flex flex-col sm:flex-row items-center bg-white rounded-full shadow-xl overflow-hidden w-full max-w-2xl">
                    {/* Location selector */}
                    <div className="flex items-center gap-2 px-5 py-3.5 flex-1 border-b sm:border-b-0 sm:border-r border-gray-200 w-full">
                        <svg
                    ...
                    {/* Type selector */}
                    <div className="flex items-center gap-2 px-5 py-3.5 flex-1 w-full">
                        <select className="bg-transparent text-gray-500 text-sm flex-1 outline-none cursor-pointer appearance-none">
                    ...
                    {/* Search button */}
                    <button className="bg-orange-500 hover:bg-orange-600 transition-colors text-white p-4 shrink-0 rounded-full m-1.5">
